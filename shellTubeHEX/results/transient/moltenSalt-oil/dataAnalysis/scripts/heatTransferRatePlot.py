...
cp1 = 1396.018 + (0.172 * temperature1)  # J/kg*K
density1 = 2263.723 - (0.636 * temperature1)  # kg/m^3
cp2 = 1396.018 + (0.172 * temperature2)  # J/kg*K
...
#plt.plot(time900, Q4, label='Ushell = 0.079479(m/s)', color='green')
...
fileName ="heatTransferRatePlotGeneralUpdated"
