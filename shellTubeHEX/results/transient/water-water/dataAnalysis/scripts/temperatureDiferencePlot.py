...
data6 = pd.read_csv("/media/henrique/Elements/heatExchangerSimulation/shellTubeHEX/transient/water-water/generalDataAnalysis/data/noBaffles/outletResultsNoBaffleRe5000.csv")
...
plt.title('Outlet Average Difference - Baffles vs No Baffles')
