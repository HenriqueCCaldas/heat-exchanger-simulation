...
data3 = pd.read_csv("/media/henrique/Elements/heatExchangerSimulation/shellTubeHEX/transient/results/generalDataAnalysis/data/outletResults0-05_300.csv")
...
plt.plot(time300, temperature3, label='Ushell = 0.05 (m/s), Re = 5000', color='blue')
plt.legend()
plt.xlabel('Time (s)')
