...
*/
//+
Physical Surface("shellInlet", 184) = {2};
Physical Surface("shellOutlet", 185) = {141};
Physical Surface("tubeOutlet", 187) = {1};
Physical Surface("tubeInlet", 186) = {99};
Physical Surface("shellWall", 188) = {116, 112, 120, 124};
Physical Surface("coupleInlet", 189) = {183};
Physical Surface("coupleOutlet", 190) = {77};
Physical Volume("metalSolid", 191) = {3};
Physical Volume("shellFluid", 192) = {2};
Physical Volume("tubeFluid", 193) = {1};
